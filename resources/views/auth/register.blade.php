            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="imageClient" class="col-md-4 col-form-label text-md-right">{{ __('imageClient') }}</label>

                            <div class="col-md-6">
                                <input id="imageClient" type="text" class="form-control @error('imageClient') is-invalid @enderror" name="imageClient" value="{{ old('imageClient') }}" required autocomplete="imageClient" autofocus>
